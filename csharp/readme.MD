The main solution/program is in the directory PEMCollection.  Like the name already reveals it is a collection of 3 microprocessor simumaltions. Each constructed on top of the previous one.
