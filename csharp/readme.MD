The main solution/program is in the directory PEMCollection.  Like the name already reveals it is a collection of 3 microprocessor simumlations. Each constructed on top of the previous one.
