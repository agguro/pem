...
$(document).ready(function () {
    ...
    $("button#bttnstart").click(function () {
        ...
        $(".active,.clear").reset();
        $("#t0,#hlt,#con,#busctrllines,.ctrlep,.ctrllm,#remarkhlt").set();
    ...
    $("button#bttnclock").click(function () {
        ...
        switch (clockpuls) {
            ...
            case 6:
                ...
                switch (opcode) {
                    case "hlt":
                        alert("end simulation opcode HLT");
            ...
            case 11:
                switch (opcode) {
                    case "lda":
                        alert("end simulation opcode LDA");
                        window.location.reload(true);
                        break;
                    case "add":
                    case "sub":
                ...
                break;
            case 12:
                alert("end simulation opcode " + opcode.toUpperCase());
                window.location.reload(true);
                break;
        }
    });
